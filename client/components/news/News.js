...
export default class News extends React.Component {
  ...
  clickHandler() {
    ...
    this.changeFeed(this.state.savefeed);
  }

  componentWillMount() {
    this.setState({
      news: 'Input RSS Feed URL',
      savefeed:'http%3A%2F%2Ffeeds.feedburner.com%2FTechcrunch'
    });
  }
