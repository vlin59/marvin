      ...
      <h1 style= { center }>ABOUT</h1>
        ...
        <div className="row page-about-description text-xs-center">
          ...
          <p>
            ...
            <br/>
          <p>
            Marvin also comes with a large array of other features like current weather, news, a todo list, a list of your saved events and even is voice activated! Not only does he come with a plethora of features but he serves them up to you on a silver plater with an easy to use Dashboard. Each component on the Dashboard can easily be customized to and adjusted to fit your liking.
          </p>
        </div>
        <h4 style={ center }>Marvin Mobile</h4>
        <p style={ center }>Need to use Marvin on the go? Marvin is now available on all mobile Android and iOS devices!</p>
        <img style={ mobile } src="../../styles/marvinmobile.png"></img>
      </div>
    )
  }
}